...
- Temporary drawing-board experiment: freeform point registration threshold is `6` internal canvas units between accepted points, doubled from the previous `3`, to compare visible point density and smoothness.
