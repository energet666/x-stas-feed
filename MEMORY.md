...
- The custom drawing brush size input supports quick left-button drag adjustment: press on the input and drag upward to increase or downward to decrease, using 3px per brush-size step after a small movement threshold. The same 1-96 clamp and localStorage persistence path as typed/wheel changes is used.
